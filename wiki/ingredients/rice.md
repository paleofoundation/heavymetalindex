...
used_in_products: [mixed-meals-rice-containing, plant-milks-rice-based, teething-and-snacks-rice-based]
...
This node is linked from [[products/mixed-meals-rice-containing]], [[products/plant-milks-rice-based]], [[products/teething-and-snacks-rice-based]].
...
[[sources/damato2026-inorganic-arsenic-rice-based-beverages]] reports finished rice-based beverage values. These values belong on [[products/plant-milks-rice-based]], not in this ingredient profile. [[sources/fera2014-fsa-metals-infant-foods-formula]] remains the current ingredient/composite source already reflected in this page's in-progress state.
