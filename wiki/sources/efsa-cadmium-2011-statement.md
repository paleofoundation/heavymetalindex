---
type: source
cite_key: efsa-cadmium-2011-statement
title: "Statement on Tolerable Weekly Intake for Cadmium"
authors: ["EFSA Panel on Contaminants in the Food Chain (CONTAM)"]
year: 2011
publication: "EFSA Journal 2011;9(2):1975 (revised 2012;10(1):2551)"
...
access_url: https://www.efsa.europa.eu/en/efsajournal/pub/1975
...
License `public-reference-only` (default for EFSA scientific outputs). The primary PDF is at the canonical EFSA URL listed in `access_url`; SHA-256 verification is pending future ingest. The information recorded above is consistent across the two primary documents (EFSA 2009 and JECFA 91st 2022) that cite this statement; specific quantitative claims that could only be in the 2011 statement itself (updated dietary exposure estimates, specific methodological detail of the EFSA-JECFA reconciliation) are not recorded here pending direct ingestion.

The reaffirmation of the 2009 TWI without numeric change means the operative EU regulatory cadmium reference value is still 2.5 µg/kg b.w./week. The 2011 statement matters for the wiki primarily as the EU-side articulation of why EU and JECFA values diverge despite operating against overlapping primary literature, which is a load-bearing fact for the [[synthesis|cadmium synthesis]].
