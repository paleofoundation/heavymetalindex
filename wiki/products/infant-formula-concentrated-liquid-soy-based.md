...
_Stub page. This bridge node exists for sources that report concentrated liquid soy-based formula, which is not one of the locked Category 1 rows but is part of the formula evidence graph._
