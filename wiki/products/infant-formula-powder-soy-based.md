...
This page is a structural scaffold for HMTc Category 1 row 2. One broad infant-formula source has been promoted from `raw/` to `wiki/sources/`; powder-specific and Al/Ni-specific evidence is still pending.

## Scaffold Status

- Page state: structural scaffold, not synthesis.
- Source coverage: 1 A-tier / 0 B-tier sources.
- Next ingest target: formula-specific [[metals/aluminum|Al]], [[metals/nickel|Ni]], and [[metals/cadmium|Cd]] data for soy-based powdered infant formula.
...
Powder-specific risk characterization for [[metals/aluminum|Al]] and [[metals/nickel|Ni]] remains pending. <!-- UNCITED: Need soy-based powdered infant formula sources that measure Al and Ni and distinguish powder from ready-to-feed liquid formula. -->
