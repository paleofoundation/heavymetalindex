...
The largest interpretive issue is scope. China-market, Brazil-market, UK-market, Canada-historical, and EU-pooled-basket values should not be silently merged into a single U.S. certification pool. They can show what has been observed in formula, but a U.S. standard should give highest weight to current U.S. individual-product formula data once that source set is available.
