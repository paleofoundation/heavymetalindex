...
| [[metals/arsenic-inorganic]] (iAs) | [[regulations/fda2020-inorganic-arsenic-infant-rice-cereal]]: Federal FDA final action level: 100 ug/kg iAs. Scope: all types of infant rice cereals. Basis: as sold infant rice cereal. | Promoted field evidence exists, but comparable product-row values have not been extracted yet. | Limit is visible, but exceedance comparison is blocked until product-row values are extracted and basis/species match. | [[regulations/fda2020-inorganic-arsenic-infant-rice-cereal]]; [[sources/fera2014-fsa-metals-infant-foods-formula]] |
