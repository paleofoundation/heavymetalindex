...
| --- | --- | --- | --- | --- |
| [[metals/lead]] (Pb) | contaminated-platform P10 | 3 sources; 1 distribution source; 2 summary sources; N=256 | Below confidence gate: only one fit distribution source is loaded. | 20 ug/kg (fda2025_pb_dry_infant_cereal_20) |
| [[metals/cadmium]] (Cd) | contaminated-platform P10 | 3 sources; 1 distribution source; 2 summary sources; N=252 | Below confidence gate: only one fit distribution source is loaded. | 40 ug/kg (eu2023_cd_babyfood_cereal_40) |
| [[metals/arsenic-total]] (tAs) | contaminated-platform P10 | 3 sources; 1 distribution source; 2 summary sources; N=253 | Below confidence gate: only one fit distribution source is loaded. | No loaded cap |
| [[metals/arsenic-inorganic]] (iAs) | contaminated-platform P10 | 2 sources; 0 distribution sources; 2 summary sources; N=272 | Not estimable from summaries alone; needs sample-level values or the exact target percentile. | 100 ug/kg (fda2020_ias_infant_rice_cereal_100) |
| [[metals/mercury-total]] (tHg) | contaminated-platform P10 | 1 source; 1 distribution source; 0 summary sources; N=64 | Below confidence gate: only one fit distribution source is loaded. | No loaded cap |
...
| Rice-based infant cereal iAs summary | [[metals/arsenic-inorganic|Inorganic arsenic]] | Baby rice and rice cereals from EU present study plus US FDA survey | baby rice n=29/85; rice cereals n=53/105 | source-reported medians and ranges | baby rice medians 114-121 ppb; rice cereal medians 75-91 ppb; highest rice cereal value 323 ppb | Supports species-specific summary context only | Dry-weight table values; no p90 or p95 reported or inferred. [[sources/signes-pastor2016-inorganic-arsenic-rice-products-infants]] |
...
| [[metals/arsenic-inorganic|Inorganic arsenic]] | Baby rice and rice cereals from EU present study plus US FDA survey | baby rice medians 114-121 ppb; rice cereal medians 75-91 ppb; highest rice cereal value 323 ppb | baby rice medians 114-121 ppb; rice cereal medians 75-91 ppb; max 323 ppb | [[sources/signes-pastor2016-inorganic-arsenic-rice-products-infants]] | Source-reported dry-weight medians/ranges; no p90 or p95 reported or inferred. The later [[sources/signes-pastor2018-infants-dietary-arsenic-solid-food]] paper remains biomarker/exposure context, not occurrence evidence. |
