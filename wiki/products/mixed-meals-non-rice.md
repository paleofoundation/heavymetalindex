...
| --- | --- | --- | --- | --- |
| [[metals/lead]] (Pb) | clean-platform P90 | 2 sources; 1 distribution source; 1 summary source; N=78 | Below confidence gate: only one fit distribution source is loaded. | 10 ug/kg (fda2025_pb_baby_food_10) |
| [[metals/cadmium]] (Cd) | clean-platform P90 | 3 sources; 1 distribution source; 2 summary sources; N=77 | Below confidence gate: only one fit distribution source is loaded. | 40 ug/kg (eu2023_cd_babyfood_cereal_40) |
| [[metals/arsenic-total]] (tAs) | clean-platform P90 | 2 sources; 1 distribution source; 1 summary source; N=77 | Below confidence gate: only one fit distribution source is loaded. | No loaded cap |
...
| [[metals/mercury-total]] (tHg) | clean-platform P90 | 1 source; 1 distribution source; 0 summary sources; N=36 | Below confidence gate: only one fit distribution source is loaded. | No loaded cap |
