...
category: fermented-beverages-non-tea-based
hmtc_category: 5
hmtc_row: 15
...
This page is Category 5 row 15 from the locked beverage architecture. It exists as a wiki node so evidence, regulatory context, ingredient routing, and future field findings have a stable place to land.
