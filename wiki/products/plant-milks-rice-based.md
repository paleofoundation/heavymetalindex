...
This page is Category 5 row 7. It now has a usable regulatory-versus-field-finding comparison for inorganic arsenic in finished rice-based drinks.
...
| standards use              | Strong evidence for iAs prioritization; not an standards threshold           |
...
<td>No distribution-capable row is loaded for this product page yet. Standards matrix tracks 4 metal/species rows (iAs, tAs, Cd, and Pb).</td>
...
<td>1 regulatory reference value loaded (EU). 1 row currently has a direct comparison read.</td>
...
<ul>
<li><strong>iAs:</strong> Limit scope: non-alcoholic rice-based drinks. Basis: wet weight. Comparison note: Direct comparison available: product matrix, analyte species, and unit basis match. Use: External regulatory context and standards prioritization input; not an standards value.</li>
<li><strong>tAs:</strong> Limit scope: No tAs value loaded for rice-based drinks.. Comparison note: Context only; tAs is not interchangeable with iAs. Use: Speciation context only.</li>
</ul>
</details>
