...
base_taxonomy: oral-electrolyte-solution
variant_type: bridge
primary_metals_of_concern: [Al, Cd, Pb]
...
<td>No distribution-capable row is loaded for this product page yet. Standards matrix tracks 3 metal/species rows (Al, Cd, and Pb).</td>
...
_Stub page. This bridge node exists because Dabeka et al. 2011 measured oral electrolyte solutions alongside infant formulae. These products are not one of the locked Category 1 infant-food rows, but they are relevant to infant exposure context._

## Current Source Links

- [[sources/dabeka2011-canada-infant-formula-lead-cadmium-aluminum]] — Canadian oral electrolyte solution summary: Al means 48 ng/g unflavoured and 39 ng/g flavoured, Cd at 0.01 ng/g, and Pb mean 0.16 ng/g as consumed.

## Row Mapping

Keep these values separate from infant formula and food rows. They may matter for infant exposure context, especially during illness or dehydration, but they should not be pooled into formula upper-percentile or max calculations.
