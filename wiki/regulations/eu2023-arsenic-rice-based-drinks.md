---
type: regulation
title: "EU inorganic arsenic maximum level for non-alcoholic rice-based drinks"
jurisdiction: EU
...
# EU Inorganic Arsenic Maximum Level For Non-Alcoholic Rice-Based Drinks

## Value

| Field             | Value                                                                                                                                                     |
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Metal species     | Inorganic arsenic, sum of As(III) and As(V)                                                                                                               |
| Maximum level     | 0.030 mg/kg                                                                                                                                               |
| Normalized value  | 30 ug/kg                                                                                                                                                  |
| Basis             | Wet weight                                                                                                                                                |
| Product scope     | Non-alcoholic rice-based drinks                                                                                                                           |
| Regulatory source | Current EU contaminants framework: Commission Regulation (EU) 2023/915, Annex I, section 3.4.1.6; value introduced by Commission Regulation (EU) 2023/465 |

## HMI use

This is an external regulatory value for [[products/plant-milks-rice-based]]. It is not an HMTc threshold. The comparison layer may place it next to field findings from [[sources/damato2026-inorganic-arsenic-rice-based-beverages]] because the source reports the same product matrix, analyte species, and unit basis.
