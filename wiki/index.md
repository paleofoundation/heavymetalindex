...
<div class="hmi-cat-grid">
  <a href="metals/" class="hmi-cat-card">
    <div class="hmi-cat-name"><span class="hmi-cat-name-label">Metals</span><span class="hmi-cat-count">10 entries</span></div>
  ...
  <a href="regulations/" class="hmi-cat-card">
    <div class="hmi-cat-name"><span class="hmi-cat-name-label">Regulations</span><span class="hmi-cat-count">in progress</span></div>
    <div class="hmi-cat-desc">Jurisdiction-specific rules with exact agency values, effective dates, and enforcement posture.</div>
    <div class="hmi-cat-examples">FDA · EU 2023/915 · Codex · Prop 65 · BFSA</div>
  </a>
...
The Heavy Metal Index is under active development. As of April 2026, the full corpus conversion is in progress and ingest into the wiki is not yet complete. Pages visible on this site during the development period are stubs unless explicitly marked otherwise. The metals layer is the most complete; ingredients, products, regulations, and testing are at index-stub status with substantive ingest scheduled across the second and third quarters of 2026.

The category cards above show "in progress" where ingest is incomplete. When entry counts appear, they reflect actual published pages. An append-only record of ingest, query, lint, and schema events is maintained at [log](log/).
