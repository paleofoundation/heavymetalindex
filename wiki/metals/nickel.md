...
Nickel is an essential trace element for some species but not for humans, and a documented occupational carcinogen at inhalation exposures. The toxicology splits sharply by route: inhalation exposure to nickel compounds (particularly soluble salts and certain insoluble forms in occupational settings) produces lung and nasal cancer, and the US National Toxicology Program classifies nickel compounds as a class as known human carcinogens; dietary exposure to nickel produces non-cancer endpoints, primarily reproductive and developmental effects at chronic exposure and systemic contact dermatitis at acute exposure in nickel-sensitized individuals. The EFSA CONTAM Panel 2020 update established a chronic TDI of 13 µg Ni/kg b.w./day and an acute reference using a LOAEL of 4.3 µg Ni/kg b.w. for eczematous flare-up reactions in nickel-sensitized humans, applying a margin-of-exposure approach for the acute case.

Dietary nickel sources are broadly distributed across the food supply: cocoa products, nuts, legumes (especially beans), oats, whole grains, and certain leafy vegetables carry the highest concentrations. Drinking water is a meaningful additional source. Stainless steel and other nickel-alloy cookware can contribute small amounts of nickel to food during cooking, particularly for acidic foods. Nickel-containing jewelry and accessories produce dermal sensitization in approximately 10 to 15 percent of women and 1 to 3 percent of men in European populations, who are then susceptible to systemic contact dermatitis flare-ups from very low oral nickel doses.
...
| --- | --- |
| Cocoa and chocolate products | Among the highest-Ni food categories; dark chocolate higher than milk |
| Oats and oat products | Elevated relative to other cereals |
| Legumes (beans, chickpeas, lentils, soy) | Plant-family-level efficient Ni accumulators |
| Nuts (especially cashews, hazelnuts) | Elevated |
| Leafy vegetables grown on Ni-rich soil | Geography-dependent |
| Drinking water (in some regions) | Variable; corrosion of nickel-containing plumbing, well water in Ni-rich geology |
...
For consumers with diagnosed nickel-sensitivity contact dermatitis: a low-nickel diet has documented therapeutic value in some cases. The acute LOAEL of 4.3 µg Ni/kg b.w. corresponds to approximately 300 µg total daily nickel for a 70 kg adult — an amount that one cocoa-heavy meal can exceed. A clinical low-nickel diet typically excludes or limits cocoa, nuts, legumes (especially soy and chickpea), oats, whole grains, certain leafy vegetables (spinach, lettuce), shellfish, canned foods, and tap water from nickel-plumbed sources. The diet is typically tried for 4 to 6 weeks under clinical supervision to assess whether dermatitis improves. A nickel-aware patient consumer is the operative population for this dietary intervention; consumers without diagnosed sensitivity should not pre-emptively adopt a restrictive low-nickel diet.

For consumers wearing nickel-containing jewelry: sensitization is the gateway exposure for many subsequent dietary problems. Choosing nickel-free jewelry (gold, sterling silver, titanium, platinum, surgical stainless steel marked nickel-free, polymer-coated alternatives) prevents sensitization in non-sensitized individuals and reduces dermal exposure in sensitized individuals. The EU Nickel Directive provides a regulatory floor for nickel release from skin-contact items in EU markets; equivalent US regulations are weaker.
...
Typical European dietary nickel intakes routinely exceed the chronic TDI. A cocoa-heavy or legume-heavy diet can deliver 200 to 500 µg Ni/day across all sources; that's at or below the chronic 910 µg/day TDI for a 70 kg adult but at or above the 300 µg single-meal acute LOAEL for a sensitized individual. A non-sensitized adult consuming this diet does not have an immediate health concern; a sensitized adult consuming the same diet may experience dermatitis flare-ups.

For the population question: the EFSA finding that mean dietary nickel exposure exceeds the TDI is a regulatory signal that population-level nickel intake reduction is warranted, not that any individual at typical exposure faces a defined acute health threat. The TDI is a health-protective threshold for chronic intake assuming lifetime exposure; brief exceedance is not an acute danger.

## Testing
<!-- audience: educator -->

Nickel measurement in food, water, and biological samples typically uses ICP-MS (detection limits 0.001 to 0.01 µg/L) or ICP-OES (detection limits 0.1 to 1 µg/L) for total nickel. Speciation analysis (distinguishing soluble from insoluble nickel forms, or specific compounds) is less commonly performed for routine measurement.

Biomonitoring for nickel exposure typically measures urinary nickel (recent integrated exposure, hours to days) or plasma/serum nickel. Hair and toenail nickel concentrations integrate exposure over weeks to months and are used in epidemiological studies. Patch testing for nickel-allergic contact dermatitis is the clinical diagnosis for nickel sensitization (5 percent nickel sulfate in petrolatum, applied for 48 hours to upper back).
...
For diagnosed-nickel-sensitive individuals: a clinically supervised low-nickel diet can produce documented improvement in approximately one-third to one-half of cases of recalcitrant systemic nickel contact dermatitis. The diet is typically tried for 4 to 6 weeks; foods to limit or exclude include cocoa, chocolate, nuts (cashews, hazelnuts), oats and whole-grain oats, legumes (especially soy, chickpea, lentil), certain leafy vegetables (spinach, lettuce), shellfish (shellfish carry nickel from sediment), canned foods (some), and tap water from nickel-plumbed sources (use bottled water during the trial). Allergists and dermatologists with nickel-allergy experience supervise these diets clinically.

For pregnant women: the EFSA reproductive/developmental endpoint anchoring the chronic TDI applies most directly to this population. Cocoa-heavy or legume-heavy diets during pregnancy may exceed the TDI by 2 to 3 times. The TDI itself incorporates uncertainty factors for inter-individual variability; brief exceedance is not an acute danger, but sustained exceedance during pregnancy is the regulatory concern that drove the TDI's lowering. Following the FDA/USDA Dietary Guidelines for Americans, with normal variety across protein and grain sources, generally keeps exposure within acceptable margins.

For consumers with nickel-jewelry sensitization: removing the sensitizing items, switching to nickel-free alternatives, and following a nickel-aware diet if dermatitis persists are the operative interventions. Dimethylglyoxime (DMG) test kits are available for consumer self-testing of jewelry nickel content (a positive DMG test means the item releases nickel and should be avoided by sensitized individuals).
...
- GI absorption (general): 1 to 40 percent; use 10 percent for default.
- GI absorption (fasted state, soluble salt): up to 40 percent.
- Sensitization prevalence (European): approximately 10 to 15 percent of women, 1 to 3 percent of men.
- Acute LOAEL (sensitized, oral): 4.3 µg Ni/kg b.w.
- Acute MOE threshold for low concern: ≥ 30.
- Chronic TDI: 13 µg Ni/kg b.w./day.
- High-Ni food categories for app dietary calculation: cocoa, chocolate, nuts (cashews, hazelnuts), oats, legumes (soy, chickpea, lentil, bean), leafy vegetables (spinach, lettuce), shellfish.
