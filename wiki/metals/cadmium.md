...
_This page is in active ingestion. The content below reflects the canonical Handbook on the Toxicology of Metals chapter 32 (Nordberg, Nogawa, Nordberg 2015, [[sources/nordberg2015-cadmium-chapter]]), the EFSA 2009 scientific opinion ([[sources/efsa-cadmium-contam-2009]]), the paired California OEHHA Prop 65 documents ([[sources/oehha-cadmium-prop65-evidence-1996]], [[sources/oehha-cadmium-prop65-madl-2001]]), the JECFA 91st meeting dietary exposure assessment ([[sources/jecfa-91st-cadmium-2022]]), the ATSDR 2012 Toxicological Profile ([[sources/atsdr-cadmium-toxprofile-2012]]), and the Codex CCCF17 session report ([[sources/codex-cccf17-2024]]); remaining ingests in the current batch are Casarett Essentials Ch 23 and Patty's Ch 7. Operative 1985 EPA IRIS record, Codex Standard CXS 193-1995, and CXC 81-2022 (Cocoa Beans CoP) are flagged as pending for later ingest waves. Full synthesis across sources will follow the regulatory batch._

## Overview

Cadmium is a non-essential heavy metal found as an environmental contaminant, entering the human food system both through natural occurrence and through industrial and agricultural sources, most notably the use of phosphate fertilizers on agricultural soils, atmospheric deposition from metal refining, and the biological accumulation in filter-feeding marine invertebrates. For the non-smoking general population, food is the main source of cadmium exposure. The metal is absorbed at low rates from the gut (3 to 5 percent on average), is efficiently retained in the kidney and liver with a biological half-life of 10 to 30 years, and accumulates over the human lifespan. It is classified by the International Agency for Research on Cancer as a Group 1 human carcinogen on the basis of occupational studies, and more recent general-population data have been statistically associated with increased risk of cancer in the lung, endometrium, bladder, and breast, though the dose-response data were deemed insufficient by EFSA for quantitative carcinogenicity-based risk assessment.

The European Food Safety Authority Panel on Contaminants in the Food Chain established a tolerable weekly intake for cadmium of 2.5 µg per kilogram body weight per week in 2009, replacing the earlier JECFA provisional tolerable weekly intake of 7 µg/kg b.w./week. The mean European adult dietary exposure is close to or slightly exceeding this TWI, with subgroups including vegetarians, children, smokers, and residents of highly contaminated areas exceeding the TWI by approximately twofold. Further reference values from other bodies (JECFA 2010, US EPA IRIS, US ATSDR, California OEHHA Prop 65) are pending ingest and will populate this page with their respective values and endpoints.
...
Cardiovascular effects remain contested in the literature. Animal studies and some human biomonitoring studies report associations between cadmium exposure and blood pressure, atherosclerosis, peripheral arterial disease, and cardiovascular mortality; other studies do not reproduce these associations. The Handbook chapter concludes that the evidence continues to be variable and that residual confounding, particularly by tobacco smoke, cannot be excluded in much of the positive literature. The wiki treats cadmium cardiovascular effects as a plausible but not established endpoint.
...
Populations for which cadmium exposure warrants particular attention, based on the EFSA analysis:

| Population | Basis |
| --- | --- |
| Vegetarians | Mean dietary exposure up to 5.4 µg/kg b.w./week, from high cereal, nut, oilseed, and pulse consumption |
| Children | Mean exposure approximately 60 percent higher than adults due to greater food intake relative to body weight; UK toddlers 1.5-4.5 years had exposure 165 percent higher than adults |
| Women of reproductive age with low iron stores | Gut absorption of cadmium is substantially elevated with low iron status |
| Regular consumers of bivalve molluscs | Mean exposure 4.6 µg/kg b.w./week |
| Regular consumers of wild mushrooms | Mean exposure 4.3 µg/kg b.w./week |
...
| Smokers | Tobacco smoking produces an internal cadmium exposure comparable in magnitude to dietary intake |

## Open questions

Two load-bearing open questions are surfaced by the EFSA ingest and will be revisited as the batch completes.

First, the EFSA TWI of 2.5 µg/kg b.w./week (2009) and the JECFA PTMI of 25 µg/kg b.w./month (2010, equivalent to about 5.8 µg/kg b.w./week) disagree by roughly a factor of 2.3 on essentially the same primary literature. The EFSA 2011 statement articulates the EU-side explanation for this divergence; that statement is not yet in the raw corpus. Synthesizing across the two bodies cannot paper over the gap; the wiki must state both values and explain the derivation differences. See [[synthesis]] for tracking.

Second, the carcinogenicity dose-response for dietary cadmium at general-population exposures remains unresolved. EFSA's 2009 risk characterization rests on the renal endpoint because the carcinogenicity data were judged insufficient for quantitative modeling, but IARC maintains the Group 1 classification, and more recent general-population epidemiology has produced statistical associations for lung, endometrium, bladder, and breast cancers. The synthesis will need to be careful about under- versus over-claiming on cancer risk.
...
_Pending: Casarett Essentials Ch 23 (Ufelle & Barchowsky 2021), Patty's Ch 7 (Jakubowski 2012). EPA IRIS deferred (raw is a 1999 draft; operative 1985 record pending). JECFA 73rd meeting primary derivation documents for the PTMI pending. Codex Standard CXS 193-1995 (matrix-level Cd MLs) and CXC 81-2022 (Cocoa Beans CoP) also pending for later ingest waves._
