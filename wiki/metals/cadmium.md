...
The primary target organ of cadmium toxicity is the kidney, specifically the proximal tubular cells of the renal cortex, where cadmium accumulates bound to metallothionein and gradually induces tubular dysfunction. The earliest detectable biological response is an increase in the urinary excretion of low molecular weight proteins, particularly beta-2-microglobulin (B2M), reflecting loss of tubular reabsorption capacity. Prolonged or high exposure may progress from tubular damage to decreased glomerular filtration rate and eventually to renal failure. Cadmium also causes bone demineralization, either through direct effects on bone or indirectly through renal dysfunction, and this bone effect is the mechanism underlying itai-itai disease, a severe osteomalacia and renal syndrome first described in Japan in the 1950s in a heavily cadmium-polluted region.
...
Dietary intake is the dominant route for the non-smoking general population. Tobacco smoking can contribute an internal exposure comparable to dietary intake. House dust can be an important source of exposure for children. Inhalation exposure in the non-smoking general population contributes only marginally to total body burden.

Gut absorption is typically 3 to 5 percent of ingested cadmium, varying across a 1 to 10 percent range depending on individual factors. Low body iron stores, common in women of reproductive age, increase absorption substantially; multiple pregnancies, preexisting health conditions, and nutritional deficiencies also raise absorption. These individual-level variability factors are incorporated into the EFSA TWI derivation through the toxicokinetic model, which is why the Panel applied no additional uncertainty factor for individual susceptibility.
