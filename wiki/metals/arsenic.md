...
Dietary intake is the dominant route in non-groundwater-affected populations ([[sources/efsa-arsenic-contam-2009|EFSA 2009]]). Rice and [[ingredients/rice|rice]]-based foods carry the highest inorganic arsenic concentrations among common dietary commodities; brown [[ingredients/rice|rice]] is higher than white [[ingredients/rice|rice]] because the bran concentrates the metal ([[sources/su-2023-arsenic-brown-rice|Su et al. 2023]]); [[ingredients/rice|rice]]-based infant cereal is a particular concern because [[ingredients/rice|rice]] is often the first solid food ([[sources/fda-iAs-rice-cereal-2020|FDA 2020]]). Drinking water from contaminated wells, certain seafoods (with the caveat that the dominant species in finfish is the relatively nontoxic arsenobetaine) <!-- UNCITED -->, seaweed (which contains both inorganic and organic species and can carry elevated total-arsenic concentrations, particularly hijiki) <!-- UNCITED -->, and some fruits and fruit juices grown on arsenic-contaminated soils round out the major dietary contributors. Apple juice and grape juice have produced documented elevated inorganic arsenic measurements in some products <!-- UNCITED -->.

Pulmonary absorption of inhaled arsenic (relevant to occupational and smoke exposure) is in the range of 30 to 60 percent depending on particle size and solubility <!-- UNCITED -->. GI absorption of soluble inorganic arsenic is 80 to 90 percent, substantially higher than for [[metals/cadmium|cadmium]] or lead <!-- UNCITED -->.
...
For older children and adults: white [[ingredients/rice|rice]] carries less inorganic arsenic than brown [[ingredients/rice|rice]] from the same source, on the order of 50 percent less by mass ([[sources/su-2023-arsenic-brown-rice|Su et al. 2023]]). Rinsing [[ingredients/rice|rice]] before cooking and cooking [[ingredients/rice|rice]] in excess water (drained) reduces iAs by approximately 40 to 50 percent (a well-documented intervention), at the cost of some water-soluble nutrients <!-- UNCITED -->. Diversifying grain sources (wheat, oats, barley, quinoa, millet) reduces total dietary iAs in [[ingredients/rice|rice]]-heavy diets <!-- UNCITED -->.

For drinking water: private-well users in arsenic-affected regions (US Southwest, New England, parts of the upper Midwest) should test their water through an EPA-certified laboratory <!-- UNCITED -->. Treatment options for elevated arsenic include reverse osmosis (effective for both As(III) and As(V)), specific arsenic adsorbent filters, and source substitution (deeper or differently-sited well, public water connection where available) <!-- UNCITED -->. Boiling does not remove arsenic and concentrates it as water evaporates; boiled water from an arsenic-contaminated source has higher arsenic per volume than the source water <!-- UNCITED -->.

For pregnancy and pre-pregnancy: the developmental window includes both gestation and the year preceding conception (because arsenic deposits in maternal tissues over time) <!-- UNCITED -->. Reducing [[ingredients/rice|rice]] consumption during pregnancy and avoiding apple-juice-heavy hydration are reasonable precautionary moves <!-- UNCITED -->. For groundwater-arsenic-affected regions, pre-conception water testing is the highest-leverage step <!-- UNCITED -->.
...
Inorganic arsenic measurement requires speciation analysis to distinguish iAs from organic arsenic species (arsenobetaine, arsenosugars, MMA, DMA). The standard analytical method is HPLC-ICP-MS, in which liquid chromatography separates the species before ICP-MS detection. Detection limits in the 0.001 to 0.1 µg/L range are achievable ([[sources/navaretnam-2025-rice-as-speciation|Navaretnam et al. 2025]]). Total-arsenic ICP-MS without speciation is informative for samples where the species distribution is known (rice, drinking water in non-marine watersheds), but is misleading for samples with substantial organic-arsenic content (seafood, particularly fish) <!-- UNCITED -->.

Biomonitoring for arsenic exposure typically measures urinary inorganic arsenic plus its methylation metabolites (sum of iAs + MMA + DMA, sometimes denoted U-iAs) ([[sources/thomas-2021-arsenic-methylation|Thomas 2021]]). Urinary arsenobetaine is excluded because it is a marker of recent fish consumption rather than inorganic arsenic exposure <!-- UNCITED -->. Hair and toenail arsenic concentrations integrate exposure over weeks to months and are used in epidemiological studies of chronic exposure <!-- UNCITED -->.
...
The current EPA drinking water MCL of 10 ppb represents a 5-fold reduction from the 50 ppb standard that had been in place since 1942. The reduction was finalized in 2001 and effective for compliance from January 23, 2006 ([[sources/epa-arsenic-drinking-water-mcl|EPA Arsenic MCL]]). The driving evidence base was the cancer epidemiology in moderately arsenic-exposed populations (the Taiwanese blackfoot-disease cohort being the historical anchor; subsequent cohorts in Argentina, Chile, Bangladesh, India, and parts of the United States contributed additional dose-response data) <!-- UNCITED -->. EPA's 2001 final rule represents the policy translation of the conclusion that arsenic-induced cancer occurs at exposures well below the 1942-era 50 ppb threshold ([[sources/epa-arsenic-drinking-water-mcl|EPA Arsenic MCL]]).

The Bangladesh and West Bengal arsenic groundwater catastrophe is the largest mass poisoning of a population in human history: tens of millions of people exposed to drinking-water arsenic in the range of 10 to 1000+ µg/L, beginning in the 1970s when shallow tube wells were promoted as a microbiologically safer alternative to surface water <!-- UNCITED -->. The resulting cancer, cardiovascular, and neurodevelopmental morbidity is still actively being characterized <!-- UNCITED -->. The cohort literature from this region, alongside the Taiwanese cohort, is the empirical base on which EFSA, EPA IRIS, and ATSDR derive their current arsenic reference values <!-- UNCITED -->.
...
| Pregnant women | Transplacental transfer; documented neurodevelopmental associations in cohort studies <!-- UNCITED --> |
| Groundwater-affected populations | Bangladesh, West Bengal, parts of US Southwest and New England, parts of Latin America <!-- UNCITED --> |
| Frequent [[ingredients/rice|rice]] consumers (gluten-free, certain cuisines) | Higher than population mean dietary inorganic arsenic <!-- UNCITED --> |
| Frequent seaweed consumers | Hijiki and certain other species carry elevated inorganic As <!-- UNCITED --> |
...
For pregnant women: dietary inorganic arsenic crosses the placenta <!-- UNCITED -->. Reduce [[ingredients/rice|rice]] and [[ingredients/rice|rice]]-based food frequency during pregnancy if your pre-pregnancy diet was [[ingredients/rice|rice]]-heavy; consider apple juice substitution or dilution; for groundwater-arsenic-affected regions, test water before conception and use treated or alternative water during pregnancy <!-- UNCITED -->. The OEHHA Proposition 65 California listing for inorganic arsenic compounds (cancer) applies to consumer products sold in California ([[sources/oehha-arsenic-prop65-listing|OEHHA Prop 65]]).

For private-well users in known arsenic-affected regions: state public-health agencies in Arizona, New Mexico, Maine, New Hampshire, and other arsenic-affected states publish local groundwater-arsenic maps <!-- UNCITED -->. Test your well water through an EPA-certified laboratory; if levels exceed 10 µg/L, treat (reverse osmosis or specific arsenic-adsorbent filters), substitute (deeper well, public water connection where available), or reduce consumption from that source <!-- UNCITED -->. Boiling does not remove arsenic <!-- UNCITED -->.

For frequent [[ingredients/rice|rice]] consumers (gluten-free diets, certain regional cuisines, vegetarians and vegans relying on [[ingredients/rice|rice]] as a primary grain): white [[ingredients/rice|rice]] carries less iAs than brown [[ingredients/rice|rice]] from the same source ([[sources/su-2023-arsenic-brown-rice|Su et al. 2023]]); basmati [[ingredients/rice|rice]] tends to carry less than other varieties <!-- UNCITED -->; [[ingredients/rice|rice]] from the southern US has historically tested higher than [[ingredients/rice|rice]] from California or imported from Thailand or India, though brand-level testing data are the operative benchmark <!-- UNCITED -->. Consider grain diversification (oats, barley, quinoa, millet, sorghum, teff) to reduce total dietary iAs while maintaining gluten-free or vegetarian dietary patterns <!-- UNCITED -->.
...
- GI absorption (soluble iAs): 80 to 90 percent; use 85 percent for default <!-- UNCITED -->.
- Pulmonary absorption (inhaled iAs): 30 to 60 percent <!-- UNCITED -->.
...
- Cooking-water-discard intervention for [[ingredients/rice|rice]]: approximately 40 to 50 percent iAs reduction <!-- UNCITED -->.
- Rice variety multiplier: brown [[ingredients/rice|rice]] is approximately 2x white [[ingredients/rice|rice]] ([[sources/su-2023-arsenic-brown-rice|Su et al. 2023]]); basmati is below other varieties <!-- UNCITED -->.
